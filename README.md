...
&nbsp; &nbsp; With the basic rule of matrix multiplication, we would have the same formula of products no matter <a href="https://www.codecogs.com/eqnedit.php?latex=$\Psi$" target="_blank"><img src="https://latex.codecogs.com/gif.latex?$\Psi$" title="$\Psi$" /></a> is a number or a column vector.         
