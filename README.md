...
&nbsp; &nbsp; If we take the transformation of the rotating object's representation from a three-dimensional vector to three-dimensional spinor, we can achieve the group homomorphism of rotation.          
