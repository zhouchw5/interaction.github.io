...
, we just need to verify this factor as the upper bound of the ratio of the approximated-solution value to the optimal value.          
               
2. Updated on 13th Feb., 2019: I was not the only isolated guy that thought Dr.Batu had stolen some critical steps in explaining the number 
