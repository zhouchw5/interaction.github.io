...
we should fix a minimum cut C of size k firstly in graph G. Based on this assumption, some classmates asked me why the minimum degree is at least k and the graph has at least kn/2 edges. 
